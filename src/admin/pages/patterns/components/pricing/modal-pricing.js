				...
				{filteredItems.length ? (
						...
						return (
							<AtrcWrap
								...
								<AtrcWrap className='ps-card at-bdr at-p'>
									{pricingData.planContent.sort.map((sortItem, iDx1) => {
										iDx1 = iDx1 + '-plan-content';
										...
										switch (sortItem) {
											...
											case 'planDesc':
												return showItem &&
													...
													<AtrcList
														key={iDx1}
														className='ps-plan__desc at-m at-bdr at-p at-gap at-flx at-flx-col'>
														{currentProductInfo.desc.map((itm, iDx2) => {
															iDx2 = iDx2 + '-product-desc';

															return (
																<AtrcLi
																	key={iDx2}
																	className='at-flx at-gap at-al-itm-st at-txt at-bdr at-p'>
																	<AtrcIcon
																		type='svg'
											...
											case 'licenseDesc':
												return showItem &&
													...
													<AtrcList
														key={iDx1}
														className='ps-plan__desc at-m at-bdr at-p at-gap at-flx at-flx-col'>
														{currentLicenseInfo.desc.map((itm, iDx3) => {
															iDx3 = iDx3 + '-license-desc';
															return (
																<AtrcLi
																	key={iDx3}
																	className='at-flx at-gap at-al-itm-st at-txt at-bdr at-p'>
											...
											case 'recurringDesc':
												return showItem &&
													...
													<AtrcList
														key={iDx1}
														className='ps-plan__desc at-m at-bdr at-p at-gap at-flx at-flx-col'>
														{currentRecurringInfo.desc.map((itm, iDx4) => {
															iDx4 = iDx4 + '-recurring-desc';
															return (
																<AtrcLi
																	key={iDx4}
																	className='at-flx at-gap at-al-itm-st at-txt at-bdr at-p'>
					...
					<AtrcWrap
						className={classNames(
							'ps-pricing__modal--cont-not-found',
							'at-col-12',
							'at-p',
							'at-bg-cl',
							'at-cl',
						...
						{__(
							'The selected pricing plan could not be found. Please review the other available plans.',
							'patterns-store'
						)}
					</AtrcWrap>
				)}
...
const ModalPricing = ({ id, setShowModal }) => {
	...
	return (
		<AtrcModal
			className={classNames(
				'ps-pricing__modal',
				loading ? 'ps-pricing__modal-loading' : ''
			)}
